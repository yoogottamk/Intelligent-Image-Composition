...
class Graph:
    ...
    def add_edges(self, i, j, w, revw):
        ...
        fromI = Edge()
        fromI.dst = j
        fromI.next = self.vertices[i].first
        fromI.weight = w
        self.vertices[i].first = a
        self.edges.append(fromI)

        toI = Edge()
        toI.dst = i
        toI.next = self.vertices[j].first
        toI.weight = revw
        self.vertices[j].first = a + 1
        self.edges.append(toI)

    def add_term_weights(self, i, source_weight, sink_weight):
        dw = self.vertices[i].weight
        source_weight += (dw > 0) * dw
        sink_weight -= (dw <= 0) * dw

        self.flow += min(source_weight, sink_weight)
        self.vertices[i].weight = source_weight - sink_weight
    ...
    def max_flow(self):
        ...
        while True:
                ...
                if v.parent:
                    ...
                    while ei != 0:
                        if self.edges[ei ^ vt].weight == 0:
                            ...
                            continue
                        u = self.vertices[self.edges[ei].dst]
            ...
            for k in range(1, -1, -1):
                v = self.vertices[self.edges[e0 ^ k].dst]
                ...
                while True:
                    ...
                    v = self.vertices[self.edges[ei].dst]
            ...
            while len(orphans) != 0:
                ...
                while ei != 0:
                    ...
                    while True:
                        ...
                        u = self.vertices[self.edges[ej].dst]
                    ...
                    if d < float("inf"):
                        ...
                        while u.ts != curr_ts:
                            ...
                            d -= 1
                            u.dist = d
                            u = self.vertices[self.edges[u.parent].dst]
                ...
                while ei != 0:
                    ...
                    if ej > 0 and self.vertices[self.edges[ej].dst] == v2:
                        orphans.append(u)
                        u.parent = -2
                    ei = self.edges[ei].next
